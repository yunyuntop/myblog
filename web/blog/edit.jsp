		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 blog-main">
					<div class="row">
						<form action="${pageContext.request.contextPath }/editUserAction  " method="post">
							<div class="main-user ">

								<div class="left-user">
									<a href="${pageContext.request.contextPath }/blog/upload.jsp"
										id="image"> <img
								...
								<div class="right-user">
									<div class="rowinfo-user">
										<span style="font-family: 方正舒体; color: #111" >昵称：&nbsp;
											<input pattern="^[0-9a-zA-Z]{6,15}$" placeholder="6-15位字母或数字" autocomplete="off" required id="username" type="text" name="username" value="${user.username}" />
											
										</span>
										<span id="err" style="color:red" name="err"> </span>
									</div>
									 
									<div class="rowinfo-user">
										<span style="font-family: 方正舒体; color: #111">签名：&nbsp;
											<input type="text" name="uinfo" value="${user.uinfo}" maxlength="11" autocomplete="off"/>
										</span>
									</div>
									<div class="rowinfo-user">
										<span style="font-family: 方正舒体; color: #111">电话：&nbsp;
											<input type="text" name="uphone" maxlength="11" value="${user.uphone}" autocomplete="off" />
										</span>
									</div>
							...
							<button type="submit" class="btn btn-xlarge btn-clean-one" id="button">确定修改</button>
						</form>
